...
public class HomePageFourthExtension implements HomePageComponent {
    ...
    public HomePageFourthExtension() {
        ...
        // --- Background image ---
        Image bgImage = new Image(getClass().getResource("/com/example/try2/images/fourth_ext_bg.png").toExternalForm());
        ...
        Image mainImage = new Image(getClass().getResource("/com/example/try2/images/cocktails.png").toExternalForm());
