...
public class HomePageFifthExtension implements HomePageComponent {
    ...
    public HomePageFifthExtension() {
        ...
        // --- IMAGES ---
        Image leftImg = new Image(getClass().getResource("/com/example/try2/images/left_dish.png").toExternalForm());
        Image rightImg = new Image(getClass().getResource("/com/example/try2/images/right_dish.png").toExternalForm());
