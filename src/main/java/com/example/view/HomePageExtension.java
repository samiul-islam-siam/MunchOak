...
public class HomePageExtension implements HomePageComponent {
    ...
    public HomePageExtension() {
        ...
        Image logoImg;
        try {
            logoImg = new Image(getClass().getResource("/com/example/view/images/logo.png").toExternalForm());
        } catch (Exception e) {
            logoImg = null;
        ...
        try {
            baseImages.add(new Image(getClass().getResource("/com/example/view/images/events1.png").toExternalForm()));
            baseImages.add(new Image(getClass().getResource("/com/example/view/images/events2.png").toExternalForm()));
            baseImages.add(new Image(getClass().getResource("/com/example/view/images/events3.png").toExternalForm()));
            baseImages.add(new Image(getClass().getResource("/com/example/view/images/events4.png").toExternalForm()));
            baseImages.add(new Image(getClass().getResource("/com/example/view/images/events5.png").toExternalForm()));
        } catch (Exception e) {
