...
public class HomePageExtension {
    ...
    public HomePageExtension() {
        ...
        // --- Background Image ---
        Image bgImage = new Image(getClass().getResource("/com/example/view/images/ext_bg.png").toExternalForm());
        ...
        // --- Fixed Logo ---
        ImageView logoView = new ImageView(new Image(getClass().getResource("/com/example/view/images/logo.png").toExternalForm()));
        ...
        // Section 1 (circle)
        sectionImages.get(0).add(new Image(getClass().getResource("/com/example/view/images/events1.png").toExternalForm()));
        sectionImages.get(0).add(new Image(getClass().getResource("/com/example/view/images/events2.png").toExternalForm()));
        sectionImages.get(0).add(new Image(getClass().getResource("/com/example/view/images/events3.png").toExternalForm()));
        sectionImages.get(0).add(new Image(getClass().getResource("/com/example/view/images/events4.png").toExternalForm()));
        sectionImages.get(0).add(new Image(getClass().getResource("/com/example/view/images/events5.png").toExternalForm()));
