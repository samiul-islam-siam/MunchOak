...
public class HomePageExtension {
    ...
    public HomePageExtension() {
        ...
        images.add(new Image(getClass().getResource("/com/example/munchoak/images/ext1.png").toExternalForm()));
        images.add(new Image(getClass().getResource("/com/example/munchoak/images/ext2.png").toExternalForm()));
        images.add(new Image(getClass().getResource("/com/example/munchoak/images/ext3.png").toExternalForm()));
