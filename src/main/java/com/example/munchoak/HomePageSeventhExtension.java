...
public class HomePageSeventhExtension {
    ...
    public HomePageSeventhExtension() {
        ...
        // --- Background image ---
        Image bgImage = new Image(getClass().getResource("/com/example/munchoak/images/seventh_ext_bg.png").toExternalForm());
        ...
        VBox section1 = createImageSection(
                "/com/example/munchoak/images/event1.png",
                "ILLISH UTTSOB",
                "02 NOV, Sunday",
        ...
        VBox section2 = createImageSection(
                "/com/example/munchoak/images/event2.png",
                "FOOD FORWARDERS",
                "20 NOV, Thursday",
                "Join Us : 4 - 8 PM",
                subtitleFont,
        ...
        VBox section3 = createImageSection(
                "/com/example/munchoak/images/event3.png",
                "CHRISTMAS EVE",
                "25 DEC, Thursday",
