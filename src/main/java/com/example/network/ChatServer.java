...
//        try (DataOutputStream dos = new DataOutputStream(new FileOutputStream(appendFile, true))) {
//
...
//        try (DataInputStream dis = new DataInputStream(new FileInputStream(readFile))) {
//
//            while (true) {
//                try {
