...
public class HomePageSixthExtension implements HomePageComponent {
    ...
    public HomePageSixthExtension(Stage primaryStage) {
        ...
        // --- LEFT & RIGHT IMAGES ---
        Image leftImg = new Image(getClass().getResource("/com/munchoak/view/images/left_dish2.png").toExternalForm());
        Image rightImg = new Image(getClass().getResource("/com/munchoak/view/images/right_dish2.png").toExternalForm());
