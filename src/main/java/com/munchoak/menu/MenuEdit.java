...
import com.munchoak.manager.CategoryStorage;
    ...
    public void chooseMenu() {
        ...
        if (file != null) {
            try {
                ...
                File destDir = new File("src/main/resources/com/munchoak/manager/data/");
...
//        }
    ...
    protected void chooseImage() {
        ...
        if (file != null) {
            try {
                File destDir = new File("src/main/resources/com/munchoak/manager/images/");
                if (!destDir.exists()) destDir.mkdirs();
