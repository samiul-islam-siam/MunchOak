...
//        if (b == null) {
//            b = new PaymentBreakdown(
//                    baseSubtotal,          // base subtotal
//                    0.0,                   // addons
//                    payment.getDiscount(), // discount
//                    payment.getTip(),      // tip
//                    7.99,                  // delivery (or 0)
//                    7.00,                  // tax (or 0)
//                    1.50,                  // service (or 0)
//                    savedFullTotal > 0 ? savedFullTotal : payment.getAmount(),
...
//        }
        ...
        for (PaymentItem pi : items) {
            //FoodItems item = foodMap.get(pi.foodId); // name only
            //String name = (item != null) ? item.getName() : "Item Removed";
            String name = pi.name;
